      ...
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                <span className="text-green-200">Plot Sales</span>
              </li>
              <li>
                <span className="text-green-200">CMDA Approved Plots</span>
              </li>
              <li>
                <span className="text-green-200">Investment Advisory</span>
              </li>
              <li>
                <span className="text-green-200">Site Visits</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-green-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <a
              href="#"
              aria-label="Facebook"
              className="w-10 h-10 flex items-center justify-center rounded-full bg-green-800 hover:bg-primary-mid transition-colors"
            >
